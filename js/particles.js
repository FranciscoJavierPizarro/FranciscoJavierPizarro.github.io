particlesJS('landing', {
  particles: {
    ...
    color: {
      value: '#ffffff' // Adjust the particle color
    },
    shape: {
      type: 'circle', // Adjust the particle shape (circle, edge, triangle, polygon, etc.)
      stroke: {
        width: 0,
        color: '#000000'
      },
    ...
    move: {
      enable: true,
      speed: 6, // Adjust the particle movement speed
      direction: 'none',
      random: false,
      straight: false,
      out_mode: 'out',
